...
% Modify this line according to the version number. Transition this
% functionality to GUI
disp('Loading previously trained version of fishnet.')
%load('fishnet_v01_trained.mat')
fishnet = fishnet_v01_trained
