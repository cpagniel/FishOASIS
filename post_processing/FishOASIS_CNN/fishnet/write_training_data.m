...
target_directory = uigetdir('', 'Select folder containing processed data & unresized images')
write_training_directories
cd(target_directory); 
    ...
    if length(strfind(current_file, 'CallLog')) == 1 
        ...
        % Do nothing, as no fish were detected 
            ...
            for j = 1:number_of_fish
               ...
               crop_name = strcat('resize/', current_species_name, '/', root_name, '-', int2str(j), '.jpg')
