...
% TODO: Rename class: boxes to class: fish
% TODO: Train the CNN and evaluate performance. 
% TODO: Gather more data and train with better dataset. 

% Load the dataset
% TODO: Prompt the user via GUI for options
load('box_dataset.mat');
target_directory = pwd;

% Add fullpath to the local image data folder
dataDir = target_directory;
...
% smallest object int he data set. 
...
% TODO: Quickly verify network performance
% TODO: Save the neural network configuration
% TODO: See if the size factor will be an issue [32 32 3]. (prediction: it
% will not be an issue).
% TODO: Retrain with different Negative/Positive overlap ranges
% TODO: Evaluate detector using the test set, per example
