...
% Next Image
%
% Called from view_image_and_acoustics to advance one image
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Clear Variables
...
elseif ii == length(PARAMS.files)
    
    % You've reached the end of the directory
    uiwait(msgbox('There are no more images in this directory. Load a new image.'));
    return
